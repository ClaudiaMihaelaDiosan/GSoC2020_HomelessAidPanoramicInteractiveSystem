package mihaela.claudia.diosan.gsoc2020_homelessaidpanoramicinteractivesystem.liquidGalaxy.legacy.data;
...
import mihaela.claudia.diosan.gsoc2020_homelessaidpanoramicinteractivesystem.liquidGalaxy.legacy.beans.POI;

import static mihaela.claudia.diosan.gsoc2020_homelessaidpanoramicinteractivesystem.liquidGalaxy.legacy.data.POIsContract.CONTENT_AUTHORITY;
import static mihaela.claudia.diosan.gsoc2020_homelessaidpanoramicinteractivesystem.liquidGalaxy.legacy.data.POIsContract.PATH_CATEGORY;
import static mihaela.claudia.diosan.gsoc2020_homelessaidpanoramicinteractivesystem.liquidGalaxy.legacy.data.POIsContract.PATH_LG_TASK;
import static mihaela.claudia.diosan.gsoc2020_homelessaidpanoramicinteractivesystem.liquidGalaxy.legacy.data.POIsContract.PATH_POI;
import static mihaela.claudia.diosan.gsoc2020_homelessaidpanoramicinteractivesystem.liquidGalaxy.legacy.data.POIsContract.PATH_TOUR;
import static mihaela.claudia.diosan.gsoc2020_homelessaidpanoramicinteractivesystem.liquidGalaxy.legacy.data.POIsContract.PATH_TOUR_POIS;
...
public class POIsProvider extends ContentProvider {
    ...
    public static void updateTaskUrlById(String itemSelectedID, String taskUrl) {
        String sql = "UPDATE LG_TASK SET " + POIsContract.LGTaskEntry.COLUMN_LG_BROWSER_URL + "='" + (taskUrl) + "' WHERE _id = ?";
    ...
    public Cursor query(@NonNull Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder) {
        ...
        switch (sUriMatcher.match(uri)) {
            ...
            case ALL_TOUR_POIS /*400*/:
                cursor = mOpenHelper.getReadableDatabase().query(POIsContract.TourPOIsEntry.TABLE_NAME, projection, selection, selectionArgs, null, null, sortOrder);
                break;
            case SINGLE_TOUR_POIS /*401*/:
                cursor = mOpenHelper.getReadableDatabase().query(POIsContract.TourPOIsEntry.TABLE_NAME, projection, TourPOIs_IDselection, selectionArgs, null, null, sortOrder);
                break;
            case ALL_TASKS /*500*/:
                cursor = mOpenHelper.getReadableDatabase().query(POIsContract.LGTaskEntry.TABLE_NAME, projection, LGTasks_IDselection, selectionArgs, null, null, sortOrder);
                break;
    ...
    public String getType(@NonNull Uri uri) {
        switch (sUriMatcher.match(uri)) {
            ...
            case ALL_TASKS /*500*/:
                return POIsContract.LGTaskEntry.CONTENT_TYPE;
            case SINGLE_TASK /*501*/:
                return POIsContract.LGTaskEntry.CONTENT_ITEM_TYPE;
            default:
                throw new UnsupportedOperationException("Unknown uri: " + uri);
        }
    }
    ...
    public Uri insert(@NonNull Uri uri, ContentValues values) {
        ...
        switch (sUriMatcher.match(uri)) {
            ...
            case ALL_CATEGORIES /*300*/:
                ...
                throw new SQLException("Failed to insert row into " + uri);
            case ALL_TOUR_POIS /*400*/:
                _id = db.insert(POIsContract.TourPOIsEntry.TABLE_NAME, null, values);
                if (_id > 0) {
                ...
                throw new SQLException("Failed to insert row into " + uri);
            case ALL_TASKS /*500*/:
                _id = db.insert(POIsContract.LGTaskEntry.TABLE_NAME, null, values);
                if (_id > 0) {
                    returnUri = POIsContract.LGTaskEntry.buildTourUri(_id);
                    break;
                }
                throw new SQLException("Failed to insert row into " + uri);
            default:
    ...
    public int delete(@NonNull Uri uri, String selection, String[] selectionArgs) {
        ...
        switch (match) {
            ...
            case ALL_TOUR_POIS /*400*/:
                ...
                break;
            case ALL_TASKS /*500*/:
                rowsDeleted = db.delete(POIsContract.LGTaskEntry.TABLE_NAME, selection, selectionArgs);
                if (rowsDeleted < 0) {
                    throw new SQLException("Failed to delete rows from " + uri);
                }
                break;
    ...
    public int update(@NonNull Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        ...
        switch (sUriMatcher.match(uri)) {
            ...
            case ALL_TOUR_POIS /*400*/:
                ...
                break;
            case ALL_TASKS /*500*/:
                rowsUpdated = db.update(POIsContract.LGTaskEntry.TABLE_NAME, values, selection, selectionArgs);
                if (rowsUpdated < 0) {
                    throw new SQLException("Failed to update rows from " + uri);
                }
                break;
