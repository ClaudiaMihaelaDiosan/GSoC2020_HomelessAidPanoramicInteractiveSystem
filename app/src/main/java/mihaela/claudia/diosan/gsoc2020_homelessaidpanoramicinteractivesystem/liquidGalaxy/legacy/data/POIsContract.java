...
public class POIsContract {
    ...
    // device.
    public static final String CONTENT_AUTHORITY = "com.mihaela.claudia.diosan.gsoc2020_homelessaidpanoramicsystem";
    ...
    public static final class CategoryEntry implements BaseColumns {
        ...
        public static int updateFatherIdAndShownNameByID(FragmentActivity fragmentActivity, String id, String fatherID, String shownName) {
            ...
            updatedValues.put(CategoryEntry.COLUMN_FATHER_ID, Integer.parseInt(fatherID));
            updatedValues.put(CategoryEntry.COLUMN_SHOWN_NAME, shownName);
